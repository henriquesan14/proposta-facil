...
namespace PropostaFacil.Infra.Migrations
{
    ...
    [Migration("20250830191141_PaymentAjustesMigrate")]
    partial class PaymentAjustesMigrate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PropostaFacil.Domain.Entities.Client", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PropostaFacil.Domain.Entities.ProposalItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PropostaFacil.Domain.Entities.Proposal", b =>
                {
                    b.HasOne("PropostaFacil.Domain.Entities.Client", "Client")
                        .WithMany("Proposals")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PropostaFacil.Domain.Entities.Subscription", b =>
                {
                    b.HasOne("PropostaFacil.Domain.Entities.SubscriptionPlan", "SubscriptionPlan")
