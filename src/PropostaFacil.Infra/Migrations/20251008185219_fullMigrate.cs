        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxProposalsPerMonth = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AsaasId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProposalsUsed = table.Column<int>(type: "integer", nullable: false),
                    SubscriptionAsaasId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerifiedToken = table.Column<string>(type: "text", nullable: true),
                    ForgottenToken = table.Column<string>(type: "text", nullable: true),
                    ForgottenTokenExpiry = table.Column<DateTime>(type: "timestamp", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentAsaasId = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
